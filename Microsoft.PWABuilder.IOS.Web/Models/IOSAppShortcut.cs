...
namespace Microsoft.PWABuilder.IOS.Web.Models
{
    ...
    public class IOSAppShortcut
    {
        ...
        public static IOSAppShortcut? FromWebManifestShortcut(WebManifestShortcutItem webManifestShortcut, Uri webManifestUri)
        {
            var name = !string.IsNullOrWhiteSpace(webManifestShortcut.Name) ? webManifestShortcut.Name : webManifestShortcut.Short_name;
